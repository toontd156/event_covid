    ...
    rl.question("Enter your date of birth (YYYY-MM-DD): ", (dob_input) => {
        ...
        if (check_date == 'Invalid Date') {
            ...
            rl.question("Enter your gender: ", (gender_input) => {
                ...
                if (gender_input !== 'ชาย' || gender_input !== 'หญิง' ) {
                    console.log('ชาย', 'หรือ', 'หญิง', 'เท่านั้น');
                    return main();
                } else {
                    const nowAge = endDate.getFullYear() - dob_input.getFullYear();
                    const DateOfBirthNowMonth = endDate.getMonth() - dob_input.getMonth();
                    ...
                    if (nowAge >= 65) {
                        ...
                        if (DateOfBirthNowMonth >= 6) {
                            let new_Start_Date = new Date(dob_input);
                    ...
                    console.log('-------------------');
                    console.log(gender_input, 'เกิดวัน', what_a_day(dob_input.getDay()), 'ที่', dob_input.getDate(), 'เดือน', what_a_month(dob_input.getMonth() + 1), 'ปี', dob_input.getFullYear() + 543);
                    if (Service_Start_Date != null) {
